...
#define SAI_SWITCH_MAX_VR_CNS           1
#define SAI_CPU_PORT_CNS                63
#define SAI_ECMP_MAX_PATHS_CNS          64
...
#define	SEVERITY_LEVEL_DEFAULT	SEVERITY_LEVEL_INFO
...
#define MRVL_SAI_ROUTER_INTF_CREATE_COOKIE_MAC(intfType, portVlan, macAddr)\
        ((uint64_t)(intfType & 0x1)<<63)|\
        ((uint64_t)(portVlan & 0x7fff)<<48)|\
