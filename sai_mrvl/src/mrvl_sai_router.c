...
sai_status_t mrvl_sai_set_virtual_router_attribute(_In_ sai_object_id_t vr_id, _In_ const sai_attribute_t *attr)
{
    ...
    return mrvl_sai_utl_set_attribute(&key, key_str, mrvl_sai_router_attribs, mrvl_sai_router_vendor_attribs, attr);
}
                                               ...
                                               _Inout_ sai_attribute_t     *attr_list)
{
    ...
    mrvl_sai_router_key_to_str(vr_id, key_str);
    return mrvl_sai_utl_get_attributes(&key, key_str, mrvl_sai_router_attribs, mrvl_sai_router_vendor_attribs, attr_count, attr_list);
}
